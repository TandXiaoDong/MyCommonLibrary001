...
namespace dgvPage
{
    public partial class dgvPageControl : UserControl
    {
        public dgvPageControl()
        {
            InitializeComponent();
        }
        ...
        public void Sx_initDataGirdView()
        {
            ...
            else
            {
                ...
                //sx_dataGirdView.DataSource = dgvData.invokeProc_DataTable(Sx_procSplitPageName, sp);
        ...
        private void Sx_queryDataCount()
        {
            if ((Sx_tableName != null && Sx_tableName.Trim().Length != 0) && (Sx_procQueryTableRecordCountName != null && Sx_procQueryTableRecordCountName.Trim().Length != 0))
            {
                ...
                object flag = new object(); //dgvData.invokeProc_ExecuteScalar(Sx_procQueryTableRecordCountName, sp);
        ...
        public void Sx_updateSplitPageLabelTip()
        {
            ...
            lbInfo.Text = "当前/总共：" + sx_currentPageIndex + "/" + sx_pageCount + "页";
        }
        ...
        private void calcPageInfo()
        {
            ...
            Console.WriteLine("当前/总共：" + sx_currentPageIndex + "/" + sx_pageCount + "页");
            if (Sx_IsAutoUpdateLabelTip)
                Sx_updateSplitPageLabelTip();
        }
        #endregion
