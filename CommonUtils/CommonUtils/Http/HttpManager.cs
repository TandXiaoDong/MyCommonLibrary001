...
using SparkSoft.Platform.Common.Extensions;
using SparkSoft.Platform.Common.Utility;
...
namespace SparkSoft.Platform.Common.Http
{
    ...
    public sealed class HttpManager
    {
        ...
        public static string GetUserAgent()
        {
            ...
            return string.Format("{0}/{1} ({2}; {3})", SparkCN_NET_SDK.ALIAS, SparkCN_NET_SDK.VERSION, SparkCN_NET_SDK.RTFX, osDesc);
        }
        ...
        public static string CreateFormDataBoundary()
        {
            ...
            return string.Format("----{0}_Boundary_{1}", SparkCN_NET_SDK.ALIAS, now.EncryptByMD5());
        }
